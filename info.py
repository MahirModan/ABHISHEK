...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '514177149 1355116689').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002065766477').split()]
...
REQ_CHANNEL = environ.get('REQ_CHANNEL', '-1002065766477')
